...
- 56 copy-ready patterns and a catalog of 62 failure modes with reproductions and fixes
...
│       ├── patterns.md     56 copy-ready Python snippets
│       └── gotchas.md      62 documented failure modes and fixes
├── LICENSE
└── README.md
```
